from mysite.serializers import PersonSerializer, TeamSerializer from mysite.models import Person, Team from rest_framework.renderers import JSONRenderer from rest_framework.parsers import JSONParser
